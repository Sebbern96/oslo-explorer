...
const styles = StyleSheet.create({
  ...
  addBtnText: { color: "#4a9eff", fontSize: 13, fontWeight: "700" },
  addStatus: { fontSize: 12, textAlign: "center", marginBottom: 8, fontWeight: "600" },
  ...
  empty: { color: "#555877", textAlign: "center", marginTop: 40, fontSize: 14, lineHeight: 22 },
});
